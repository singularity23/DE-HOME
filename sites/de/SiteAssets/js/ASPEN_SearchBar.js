...
document.head.innerHTML +=
	"<meta http-equiv=\"Content-Security-Policy\" content=\"default-src *; style-src 'self' *.bchydro.bc.ca/* 'unsafe-inline'; script-src 'self' *.bchydro.bc.ca/* 'unsafe-inline' 'unsafe-eval'\"></meta>";
