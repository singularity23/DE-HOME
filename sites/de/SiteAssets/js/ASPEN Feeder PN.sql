SELECT
  ...
  CASE
    ...
    AND S.GROUPNAME = '1'
    AND DBMS_LOB.SUBSTR (S.SETTING, 4000) <> 'OFF' THEN TO_CHAR(
      UPPER(
...
WHERE
  ...
  AND (
    ...
    OR (
      T.SETTINGNAME LIKE 'FUNCTION PARAMETERS/PARAMETER SUBSET 1/DTOC%'
    )
    OR (
      T.SETTINGNAME LIKE 'FUNCTION PARAMETERS/GLOBAL/MAIN/INOM C.T. PRIM.%'
    )
  )
  AND UPPER(DBMS_LOB.SUBSTR (S.SETTING, 4000)) != 'BLOCKED'
